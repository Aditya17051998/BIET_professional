        ...
        return (
            <div>
                ...
                {/*search.result.length>0 && this.state.isFilter && (<select onClick={this.handleSearch}> filter
                    ...
                    {search.result.length>0 && this.state.isFilter && (<div className="search-result" style={{position:"fixed",zIndex:"20",width:"40vw",left:"45vw",top:"10vh",overflowY:"scroll",background:"rgb(167, 168, 242)"}}>
                    
                    <SearchItem result={search} />

                    </div>)}

                    {search.result.length<1 && this.state.isFilter && (<div className="search-result" style={{position:"fixed",zIndex:"20",width:"40vw",left:"45vw",top:"10vh",background:"rgb(167, 168, 242)"}}><h2 style={{marginLeft:"20%",marginTop:"7%"}}> No result found</h2></div>)
